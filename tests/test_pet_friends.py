...
def test_create_pet_without_photo_with_valid_data(name='Оксана', animal_type='минипиг',
                                                  age='3'):
    """Проверяем что можно добавить питомца с корректными данными"""
...
def test_add_new_pet_without_name(name='', animal_type='двортерьер',
                                     age='13', pet_photo='images/utka.gif'):
...
def test_add_new_pet_without_photo(name='Pit', animal_type='двортерьер',
                                     age='13', pet_photo=''):
...
def test_add_new_pet_without_animal_type(name='Pit', animal_type='',
                                     age='13', pet_photo='images/utka.gif'):
...
def test_add_new_pet_without_age(name='Pit', animal_type='двортерьер',
                                     age='', pet_photo='images/utka.gif'):
...
def test_add_new_pet_without_uncorrect_age_type(name='Pit', animal_type='двортерьер',
                                     age='gvhjbhbbblj', pet_photo='images/utka.gif'):
...
def test_add_new_pet_with_age_more_then_2_symbols(name='Pit', animal_type='двортерьер',
                                     age='1234', pet_photo='images/utka.gif'):
...
def test_get_api_key_with_wrong_password(email=valid_email, password='1234567'):
...
def test_get_api_key_with_wrong_email(email='polinapolinaaaa@mail.ru', password=valid_password):
...
def test_get_my_pets_with_invalid_key(filter="my_pets"):
    ...
    _, auth_key = pf.get_api_key(valid_email, valid_password)
    status, result = pf.get_list_of_pets({'key': 'dbfc699ae3e7409cca4acb054f3433ebb881776'}, filter)
    assert status == 403

def test_create_pet_without_photo_with_invalid_key (name='Оксана', animal_type='минипиг',
                                                  age='3'):
    ...
    # Добавляем питомца
    status, result = pf.create_pet_simple({'key': 'dbfc699ae3e7409cca4acb054f3433ebb881776'}, name, animal_type, age)
